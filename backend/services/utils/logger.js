...
const REDACT_KEYS = [
  'password', 'token', 'authorization', 'jwt', 'jwt_secret',
  'apikey', 'api_key', 'vapi_api_key', 'groq_api_key', 'admin_secret',
  'cookie', 'mongodb_uri', 'whatsapp_api_key', 'webhook_secret',
  'vapi_webhook_secret', 'cloudinary_api_secret',
];
