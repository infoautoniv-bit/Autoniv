  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-16 sm:bottom-6 left-3 right-3 sm:left-6 sm:right-auto sm:max-w-md z-[200]"
        role="dialog"
        aria-label="Cookie consent"
      >
        <div className="bg-slate-900/95 backdrop-blur-xl border border-slate-800 rounded-2xl p-4 sm:p-5 shadow-2xl">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-2 justify-end shrink-0">
              ...
              <button
                ...
                className="px-4 py-2 text-xs font-medium text-white bg-indigo-600 hover:bg-indigo-500 rounded-lg transition-colors shadow-lg shadow-indigo-500/20"
