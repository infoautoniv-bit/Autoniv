...
export const testimonials = [
  ...
  { name: "Marcus Johnson", role: "Director, BrightHome Services", quote: "The AI receptionist never sleeps. Our leads increased by 40% in the first month alone. It qualifies prospects before our team even wakes up.", initials: "MJ", metric: "3× capacity", industry: "Real Estate", avatar: "#10B981", photo: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80" },
  { name: "Emily Rodriguez", role: "VP Operations, FastTrack Auto", quote: "Setup was instant. The AI sounds so natural, customers don't know it's not human. Our call handling cost dropped by 60%.", initials: "ER", metric: "2min setup", industry: "Automotive", avatar: "#8b5cf6", photo: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
  { name: "Rajesh Patel", role: "Founder, FinServe Capital", quote: "We replaced 3 full-time agents with Autoniv. The AI handles loan inquiries 24/7 and our conversion rate went up 35%.", initials: "RP", metric: "-60% costs", industry: "Finance", avatar: "#f59e0b", photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80" },
  { name: "Priya Sharma", role: "COO, EduLearn India", quote: "Admissions inquiries used to overwhelm our team. Now Autoniv handles 80% of them automatically. We enrolled 2× more students.", initials: "PS", metric: "2× enrollment", industry: "Education", avatar: "#ec4899", photo: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80" },
  { name: "James Wilson", role: "Head of CX, TravelHub", quote: "Our booking conversion jumped 55% after deploying Autoniv. Guests love the instant response — no more waiting on hold.", initials: "JW", metric: "+55% bookings", industry: "Travel", avatar: "#06b6d4", photo: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150&auto=format&fit=crop&q=80" },
];
