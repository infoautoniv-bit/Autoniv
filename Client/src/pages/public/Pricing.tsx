...
const voicePlans: Plan[] = [
  {
    name: 'Launch', icon: '🚀', iconBg: 'rgba(37,99,235,0.10)',
    monthlyPrice: '$149', yearlyPrice: '$119', period: '/month', badge: 'LAUNCH',
    monthlyPriceINR: '₹4,999', yearlyPriceINR: '₹3,999',
    desc: 'Start automating your business call volume.',
    features: ['1 AI Voice Agent','500 Minutes / month','1 Phone Number','1 AI Workflow','Lead Capture & Booking','Extra mins: ₹12/min ($0.18/min)','Basic Analytics','Email Support'],
    cta: 'Get Started', popular: false, checkColor: '#2563EB',
    border: `1px solid ${HAIRLINE}`, bg: SURFACE,
    shadow: '0 4px 20px rgba(0,0,0,0.04)', hoverShadow: '0 8px 40px rgba(0,0,0,0.08)',
    setupFee: '$499', setupFeeINR: '₹14,999',
  },
  {
    name: 'Growth', icon: '📈', iconBg: 'rgba(16,185,129,0.10)',
    monthlyPrice: '$349', yearlyPrice: '$279', period: '/month', badge: 'MOST POPULAR',
    monthlyPriceINR: '₹14,999', yearlyPriceINR: '₹11,999',
    desc: '3x the minutes of Launch for growing teams.',
    features: ['1 AI Voice Agent','1,500 Minutes / month','2 Phone Numbers','Up to 5 AI Workflows','Extra mins: ₹11/min ($0.16/min)','Multi-Language Support','CRM Integration','Priority Support'],
    cta: 'Book a Demo', popular: true, checkColor: '#10B981',
    border: '2px solid #10B981', bg: SURFACE,
    shadow: '0 8px 30px rgba(16,185,129,0.15)', hoverShadow: '0 12px 48px rgba(16,185,129,0.25)',
    setupFee: '$999', setupFeeINR: '₹29,999',
  },
  {
    name: 'Scale', icon: '⚡', iconBg: 'rgba(99,102,241,0.10)',
    monthlyPrice: '$799', yearlyPrice: '$639', period: '/month', badge: 'SCALE',
    monthlyPriceINR: '₹34,999', yearlyPriceINR: '₹27,999',
    desc: 'For high-volume operations requiring full control.',
    features: ['1 AI Voice Agent','4,000 Minutes / month','Multiple Phone Numbers','Unlimited AI Workflows','Extra mins: ₹10/min ($0.14/min)','WhatsApp Follow-ups','API & Webhooks','Priority Support'],
    cta: 'Get Started →', popular: false, checkColor: '#6366f1',
    border: `1px solid ${HAIRLINE}`, bg: SURFACE,
    shadow: '0 4px 20px rgba(0,0,0,0.04)', hoverShadow: '0 8px 40px rgba(0,0,0,0.08)',
    setupFee: '$1,999', setupFeeINR: '₹49,999',
  },
  {
    name: 'Enterprise', icon: '🏢', iconBg: 'rgba(139,92,246,0.10)',
    monthlyPrice: 'Custom', yearlyPrice: 'Custom', period: '', badge: 'ENTERPRISE',
    monthlyPriceINR: 'Custom', yearlyPriceINR: 'Custom',
    desc: 'Tailored AI automation for large organizations.',
    features: ['Unlimited Voice Agents','Custom Minutes','White Label Included','Custom Volume Pricing','Custom Integrations','24×7 Premium Support'],
    cta: 'Contact Sales', popular: false, checkColor: '#8b5cf6',
    border: `1px solid ${HAIRLINE}`, bg: SURFACE,
    shadow: '0 4px 20px rgba(0,0,0,0.04)', hoverShadow: '0 8px 40px rgba(0,0,0,0.08)',
    setupFee: 'Custom', setupFeeINR: 'Custom',
  },
];
                ...
                <table className="w-full text-left border-collapse min-w-[500px]">
                  ...
                  <tbody>
                    {[
                      ...
                      { feature: 'Branding & White Label', free: 'Visible', starter: 'Removed', growth: 'Removed', enterprise: 'White Label Included' },
                      ...
                      { feature: 'Support SLA', free: 'Email Support', starter: 'Priority Support', growth: 'Priority Support', enterprise: '24×7 Premium Support' },
                      ...
                      { feature: 'Voice Agent Calls', free: '—', starter: '500 mins/mo', growth: '1,500 mins/mo', enterprise: 'Unlimited' },
                      { feature: 'Extra Minutes Rate', free: '—', starter: '₹12/min ($0.18)', growth: '₹11/min ($0.16)', enterprise: 'Custom Volume' },
